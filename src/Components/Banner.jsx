...
const Banner = () => {
    return (
        <>
            <div className="w-full relative min-h-[400px] lg:min-h-[700px] bg-cover bg-center bg-no-repeat pt-16 md:pt-20" style={{ backgroundImage: 'url("https://i.postimg.cc/RVSTZyv8/banner.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="absolute inset-0 bg-black/60 sm:bg-black/50"></div>
                <div className="relative w-full mx-auto flex flex-col items-center justify-center min-h-[400px] lg:min-h-[600px] text-white text-center px-3 sm:px-6 lg:px-8 max-w-7xl">
