...
const Banner = () => {
    return (
        <>
            <div className="w-full relative min-h-[400px] lg:min-h-[700px] bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url("https://i.postimg.cc/RVSTZyv8/banner.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
