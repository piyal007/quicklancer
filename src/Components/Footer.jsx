      ...
      <footer className='bg-base-100 text-base-content py-8'>
        <div className='w-11/12 mx-auto'>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <div>
              ...
              <div className='space-y-2 *:text-base-content'>
                <p>Email: info@quicklancer.com</p>
                <p>Phone: +1 (555) 123-4567</p>
                <p>Address: 123 Freelance Street</p>
            ...
            {/* Quick Links */}
            <div>
              <h3 className='text-xl font-bold mb-4 text-base-content'>Quick Links</h3>
              <div className='space-y-2 *:text-base-content *:hover:text-success *:block'>
          ...
          <div className='text-center mt-8 pt-8 border-t border-gray-200'>
            <p className='text-base-content'>&copy; {new Date().getFullYear()} QuickLancer. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
