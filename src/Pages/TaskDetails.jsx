                    ...
                    <div className="p-8 sm:p-10">
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-6 mb-8">
                            <div className="space-y-4">
                                <h1 className="text-3xl sm:text-4xl font-bold text-base-content mb-2 leading-tight">{task.title}</h1>
                        ...
                        <div className="bg-base-200/50 backdrop-blur-sm rounded-2xl p-8 mb-10">
                            ...
                            <p className="text-base-content/80 leading-relaxed text-lg">{task.description}</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                            ...
                            <div className="stats shadow bg-base-100 border border-base-300">
                                <div className="stat">
                                    ...
                                    <div className="stat-title text-base-content/60">Deadline</div>
                            ...
                            <div className="stats shadow bg-base-100 border border-base-300">
                                <div className="stat">
                                    <div className="stat-figure text-secondary">
                                        <div className="badge badge-secondary badge-lg">{totalBids}</div>
                                    </div>
                                    <div className="stat-title text-base-content/60">Total Bids</div>
